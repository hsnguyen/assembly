...
```
java -cp target/assembly-0.0.2-SNAPSHOT.jar org.rtassembly.NPGraphCmd -h
...
```
java -cp target/assembly-0.0.2-SNAPSHOT.jar org.rtassembly.NPGraphCmd -gui
```
...
Below is how it looked like using *npGraph* with a mock community of 11 species from PoreCamp. This application is still on development (under branch develop).
